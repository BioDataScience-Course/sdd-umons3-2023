...
Voici comment nous pouvons surpondérer les classes plus rares par duplication, dans le cas de notre jeu de données `pima1` :
...
if (exists("challenge2"))
  challenge2("C03Ca_ml_wine", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-025' = "https://classroom.github.com/a/...",
      'sdd3late'   = "https://classroom.github.com/a/..."),
    course.starts = c(
