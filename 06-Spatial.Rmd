...
-   [Initiation à la cartographie avec {sf} & Co. par Sébastien Rochette](https://statnmap.com/fr/2018-07-14-initiation-a-la-cartographie-avec-sf-et-compagnie/) est un article de blog sur la cartographie dans R. Il a rédigé plusieurs articles sur le sujet.
...
Le résultat est aussi un objet **stars** avec deux composantes : - `var1.pred`, les prédictions - `var1.var`, la variance estimée (plus elle est grande en un point, plus la prédiction est incertaine)
...
Comme il se peut que l'interpolation ait donné des valeurs très élevées ou très, très basses en quelques points, nous allons niveler un peu tout cela vers une plage de valeurs effectivement observées.
...
```{r assign_C06Ia_map, echo=FALSE, results='asis'}
if (exists("assignment"))
  assignment("C06Ia_map", part = NULL,
    url = "https://github.com/BioDataScience-Course/C06Ia_map",
    course.ids = c(
      'S-BIOG-025'         = !"C06Ia_{YY}M_map"),
    course.urls = c(
      'S-BIOG-025'         = "https://classroom.github.com/a/tj6IZsPr"),
    course.starts = c(
      'S-BIOG-025'         = !"{W[15]+1} 08:00:00"),
    course.ends = c(
      'S-BIOG-025'         = !"{W[15]+4} 23:59:59"),
    term = "Q1", level = 3,
...
-   [Spatial Data Science with R](https://rspatial.org/raster/index.html) en anglais propose tout un chapitre consacré à la modélisation de la distribution des espèces.
